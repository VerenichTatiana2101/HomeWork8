...
int min = MinSumNumbers(result);
Console.WriteLine();
Console.WriteLine($"Номер строки с наименьшей суммой значений элементов -> {min} строка");
...
int MinSumNumbers(int[] sumNumbers)        //метод поиска номера позиции с минимальным значением
{
